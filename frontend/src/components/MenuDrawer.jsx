        ...
        <div className="row-span-3 h-screen rounded-r-3xl bg-menudrawer w-full max-w-[306] sticky top-0">
            ...
            <Link to={'/inicio'}>
                <div className=' flex hover:bg-white/20 shadow-xl hover:shadow-2xl cursor-pointer transition duration-300 rounded-xl 
                    mt-14 p-3 mr-8 ml-9 px-auto'>
                    <HomeOutlined
                        className='ml-1'
                        style={{ fontSize: '32px', color: "white" }} />
                    <h1 className='text-center mt-2 ml-5 text-white'>Inicio</h1>
                </div>
            </Link>

            <Link to={'/CrearSolicitud'}>
                <div className=' flex hover:bg-white/20 shadow-xl hover:shadow-2xl cursor-pointer transition duration-300 rounded-xl 
                    mt-8 p-3 mr-8 ml-9 px-auto'>
                    <svg width={43} height={45} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg"
                        className='my-auto'>
